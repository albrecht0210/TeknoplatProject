"""
Django settings for wildcat_server project.
...
SECRET_KEY = os.environ.get('WILDCAT_SECRET_KEY')
...
ROOT_URLCONF = 'wildcat_server.urls'
...
WSGI_APPLICATION = 'wildcat_server.wsgi.application'
...
if (not os.path.exists(JWT_PRIVATE_KEY_PATH)) or (not os.path.exists(JWT_PUBLIC_KEY_PATH)):
    ...
    generate_keys(private_key_path=JWT_PRIVATE_KEY_PATH, public_key_path=JWT_PUBLIC_KEY_PATH)
...
SIMPLE_JWT = {
    ...
    'ISSUER': 'wildcat_server',  # "iss" (Issuer) Claim
    ...
    'TOKEN_OBTAIN_SERIALIZER': 'authentication.api.serializers.WildcatTokenObtainPairSerializer',
}
